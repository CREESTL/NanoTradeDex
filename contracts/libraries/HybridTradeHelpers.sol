...
library HybridTradeHelpers {
   ...
   */
  function calculateTakerFeeQuantityInPips(
    HybridTrade memory self
   ...
   */
  function calculateTakerGrossReceivedQuantityInPips(
    HybridTrade memory self
  ) internal pure returns (uint64) {
    return (
   ...
   */
  function getMakerGrossQuantityInPips(
    HybridTrade memory self
  ) internal pure returns (uint64) {
    return
      self.orderBookTrade.takerFeeAssetAddress ==
   ...
   */
  function getMakerNetQuantityInPips(
    HybridTrade memory self
  ) internal pure returns (uint64) {
    return
      self.orderBookTrade.takerFeeAssetAddress ==
