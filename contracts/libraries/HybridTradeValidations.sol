...
import { Asset, HybridTrade, Order, OrderBookTrade, NonceInvalidation, PoolTrade } from './Structs.sol';
...
library HybridTradeValidations {
  ...
  function validateHybridTrade(
    ...
    Order memory takerOrder = hybridTrade.orderBookTrade.makerSide ==
      OrderSide.Buy
      ? sell
      : buy;
  ...
  function validateFees(HybridTrade memory hybridTrade) private pure {
    ...
    OrderSide takerOrderSide = hybridTrade.orderBookTrade.makerSide ==
      OrderSide.Buy
      ? OrderSide.Sell
      : OrderSide.Buy;
