...
import { LiquidityChangeExecutionHelpers } from './LiquidityChangeExecutionHelpers.sol';
import { LiquidityPoolHelpers } from './LiquidityPoolHelpers.sol';
import { Validations } from './Validations.sol';
import { LiquidityAddition, LiquidityChangeExecution, LiquidityPool, LiquidityRemoval } from './Structs.sol';
...
library LiquidityChangeExecutionValidations {
  ...
  function validateLiquidityRemoval(
    ...
    (uint256 minBaseInAssetUnits, uint256 minQuoteInAssetUnits) = execution
      .baseAssetAddress == removal.assetA
    ...
    (uint256 expectedBaseAssetQuantityInPips, ) = pool
      .calculateOutputAssetQuantitiesInPips(execution.liquidityInPips);
