...
import { LiquidityChangeExecutionValidations } from './LiquidityChangeExecutionValidations.sol';
...
import { ICustodian, IERC20, ILiquidityProviderToken, IWETH9 } from './Interfaces.sol';
import { LiquidityChangeOrigination, LiquidityChangeState, LiquidityChangeType, OrderSide } from './Enums.sol';
import { Asset, LiquidityAddition, LiquidityAdditionDepositResult, LiquidityChangeExecution, LiquidityPool, LiquidityRemoval, LiquidityRemovalDepositResult, PoolTrade } from './Structs.sol';
...
library LiquidityPools {
  ...
  function executeAddLiquidity(
    ...
    ILiquidityProviderToken liquidityProviderToken = validateAndUpdateForLiquidityAddition(
        self,
        addition,
        execution
      );
  ...
  function validateAndUpdateForLiquidityAddition(
    ...
    LiquidityPool storage pool = loadLiquidityPoolByAssetAddresses(
      self,
  ...
  function removeLiquidity(
    ...
    address liquidityProviderToken = address(
  ...
  function executeRemoveLiquidity(
    ...
    ILiquidityProviderToken liquidityProviderToken = validateAndUpdateForLiquidityRemoval(
        self,
        removal,
        execution,
        isWalletExited
    ...
    )
  {
    ...
    uint64 liquidityToBurnInPips = balanceTracking.updateForExit(
      msg.sender,
    ...
    uint256 outputBaseAssetQuantityInAssetUnits = AssetUnitConversions
      .pipsToAssetUnits(outputBaseAssetQuantityInPips, pool.baseAssetDecimals);
    uint256 outputQuoteAssetQuantityInAssetUnits = AssetUnitConversions
      .pipsToAssetUnits(
    ...
    returns (uint64 baseAssetReserveInPips, uint64 quoteAssetReserveInPips)
  {
    ...
    uint128 initialProduct = uint128(pool.baseAssetReserveInPips) *
