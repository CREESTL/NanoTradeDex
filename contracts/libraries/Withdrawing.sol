...
import { Asset, LiquidityChangeExecution, LiquidityRemoval, Withdrawal } from './Structs.sol';
...
library Withdrawing {
    ...
    )
  {
    ...
    Asset memory asset = withdrawal.withdrawalType == WithdrawalType.BySymbol
